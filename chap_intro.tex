...
This document will work toward these these goals and propose the
...
\item[Chapter~\ref{chap:planned} - Proposed Work:] Porpoises the
...
%%  LocalWords:  PaaS Heroku SaaS aaS FOSS Custos
