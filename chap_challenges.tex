...
Since developers lack physical control over such systems, it is
important to provide security and privacy technologies that do not
require full physical access and control as a prerequisite for secure
operation.
...
about a user's ability to physically access a machine. Such
assumptions would disenfranchise many modern
...
%%  LocalWords:  OneDrive IoT SMB OwnCloud WebDAV LAFS IaaS PaaS
