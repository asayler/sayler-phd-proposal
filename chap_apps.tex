...
\begin{figure}[t]
  \centering
  \includegraphics[height=250px]{./figs/out/App-FileStore.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[height=250px]{./figs/out/App-DataRepo.pdf}
...
%%  LocalWords:  SSaaS CMAC SSPs SSP's SSP FDE iOS Repo
